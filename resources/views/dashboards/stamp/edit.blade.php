        ...
        <form action="{{ route('dashboard.update',['dashboard'=>$stamp->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <ul>
                <li class="mb-8">
                    ...
                    <input type="text" value="{{$stamp->title}}" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm border">
                ...
                <li class="mb-8">
                    ...
                    <textarea id="description" rows="6" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm border">{{$stamp->description}}</textarea>
                </li>
            </ul>
